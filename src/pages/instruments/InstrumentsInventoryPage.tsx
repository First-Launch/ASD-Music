...
import { Preview, Edit, AssignmentInd, Add, QrCodeScanner } from '@mui/icons-material';
import PageLayout from '../../components/templates/PageLayout';
import { InstrumentDocument } from '../../utils/databaseModels';
...
const InstrumentsInventoryPage: React.FC = () => {
  ...
  return (
    <PageLayout title="Instruments Inventory" showTitleBar={true}
      actions={[
        <IconButton
          onClick={(e) => {
            e.stopPropagation();
    ...
    >
      <Container maxWidth="lg" sx={{ mt: 4 }}>
        ...
        {/* Mobile instrument dialog */}
        {selectedInstrument && isMobile && (
          <Dialog open={!!selectedInstrument} onClose={() => setSelectedInstrument(null)}>
            <DialogTitle>{selectedInstrument.serial}</DialogTitle>
            <DialogContent>
              {/* Image */}
              {selectedInstrument.primaryPhoto && (
                <CardMedia
            ...
            <DialogActions>
              <Button onClick={() => handleOpen(selectedInstrument)} color="primary">
                Edit
              </Button>
              <Button onClick={() => setSelectedInstrument(null)} color="secondary">
                Close
              </Button>
            </DialogActions>
          </Dialog>
